...
const POLARIS_DATA = {
  ...
  emotions: [
    {
      ...
      colors: {
        ...
        orb1: '#c084fc', orb2: '#e879f9', orb3: '#7c3aed'
      }
    },
    {
      id: 'anger', emoji: '🔥', title: 'Anger',
  ...
  genres: {
    ...
    love: [
      {
        id: 'classics', name: '🏆 All-Time Classics',
        songs: [
          {
            ...
            storyEn: "Written in 1961, inspired by the French melody 'Plaisir d'Amour'. Elvis recorded it for Blue Hawaii. It captures the feeling of surrendering completely to love. Voted one of the greatest love songs of all time in Rolling Stone's 500 Greatest Songs list.",
          ...
          {
            id: 'all-of-me', title: 'All of Me', artist: 'John Legend',
            ...
            storyEn: "John Legend wrote this for his then-girlfriend Chrissy Teigen. A raw celebration of loving someone completely — flaws and all. 'All of me loves all of you' became one of the most quoted lines in modern romance. Won multiple Grammys.",
            storyAr: "كتبها جون ليجند لصديقته آنذاك كريسي تيغن. احتفاء صادق بحبّ شخص بكل جوانبه. أصبحت 'كل ما فيّ يحب كل ما فيكِ' من أكثر العبارات اقتباساً في الرومانسية الحديثة."
          },
          {
            id: 'make-you-feel', title: 'Make You Feel My Love', artist: 'Bob Dylan',
            ...
            storyEn: "Bob Dylan wrote this quiet masterpiece in 1997. Though Adele's version brought it to a new generation, Dylan's original captures something purer — a love that asks nothing in return. Pitchfork calls it 'one of Dylan's most emotionally direct compositions'.",
          ...
          },
          {
            ...
            storyEn: "Ed Sheeran co-wrote this with Amy Wadge in just 30 minutes. It imagines dancing with the same person at 70 with the same fire you had at 20. Won the 2016 Grammy for Song of the Year.",
          ...
          {
            id: 'her-jvke', title: 'her', artist: 'JVKE',
            ...
            storyEn: "JVKE wrote 'her' about the overwhelming, cinematic feeling of falling in love — where ordinary moments suddenly feel extraordinary. The Gen Z anthem for that specific flutter in your chest you can't explain.",
            storyAr: "كتب JVKE أغنية 'her' عن ذلك الشعور الساحق حين تقع في الحب. أصبحت نشيد الجيل Z لرجفة الصدر التي لا تستطيع تفسيرها."
          },
          {
            id: 'something-beatles', title: 'Something', artist: 'The Beatles',
            ...
            storyEn: "Frank Sinatra called it the greatest love song ever written. George Harrison captures the inexplicable magnetic pull of a lover's movements and aura. 'Something in the way she moves attracts me like no other lover' — one of the most romantic lines in music history.",
            storyAr: "وصفها فرانك سيناترا بأنها أعظم أغنية حب كُتبت على الإطلاق. جورج هاريسون يلتقط الجاذبية المغناطيسية التي لا يمكن تفسيرها لحركات الحبيبة."
          },
          {
            id: 'at-last-eva', title: 'At Last', artist: 'Eva Cassidy',
            ...
            spotify: 'https://open.spotify.com/track/4YZGjgax8MyMh4VxYi2dNg',
            storyEn: "Originally by Etta James in 1960, Eva Cassidy's 1996 cover transforms it into a haunting, ethereal ballad. Her pure, emotive voice and stripped-down arrangement create an intimate atmosphere — the overwhelming relief of finally finding true love.",
            storyAr: "لحظة الانتصار العاطفي بعد طول انتظار. تُصور الأغنية شعور الارتياح والسكينة حين يجد الإنسان توأم روحه. هي احتفال بالنهايات السعيدة التي تمحو سنوات من البحث."
          }
        ]
      },
      {
        id: 'indie-love', name: '🎸 Indie Love',
        songs: [
          {
            id: 'first-day', title: 'First Day of My Life', artist: 'Bright Eyes',
            ...
            storyEn: "Conor Oberst wrote this as a declaration that love redefines existence — as if the world only truly began when you found that person. Quiet, acoustic, devastatingly sincere. r/indieheads ranks it as one of the greatest love songs ever written.",
          ...
          {
            id: 'such-great-heights', title: 'Such Great Heights', artist: 'The Postal Service',
            ...
            storyEn: "Ben Gibbard wrote this about feeling so perfectly matched with someone it feels like fate. Electronic beats mixed with heartfelt lyrics created something entirely new. One of the most celebrated indie love songs of the 2000s.",
            storyAr: "كتبها بن غيبارد عن الشعور بأنك أنت وشخص آخر متوافقان بشكل مثالي لدرجة أنه يبدو كالقدر."
          },
          {
            id: 'tenerife-sea', title: 'Tenerife Sea', artist: 'Ed Sheeran',
            ...
            storyAr: "تطغى عليها 'Thinking Out Loud' من نفس الألبوم، لكنها ربما أكثر أغاني إد حميمية. تصوّر لحظة واحدة متجمدة — النظر لشخص والشعور بأن عالمك ضاق حتى أصبح عينَيه فقط."
          },
          {
            id: 'somewhere-only', title: 'Somewhere Only We Know', artist: 'Keane',
            ...
            storyEn: "Tom Chaplin wrote this as a meditation on returning to a place only you and someone you love share. One of the defining anthems of 2000s emotional indie rock, later revived by Lily Allen.",
            storyAr: "كتبها توم شابلين كتأمل في العودة لمكان يعرفه أنت وشخص تحبه فقط. من أبرز أناشيد الإندي الروك العاطفي في الألفينيات."
          }
        ]
      },
      {
        id: 'kpop-love', name: '🌸 K-Pop Love',
        songs: [
          {
            id: 'spring-day', title: 'Spring Day', artist: 'BTS',
            ...
            storyEn: "Often cited as BTS's masterpiece. A longing for someone lost — to distance, time, or death. Imagery drawn from Ursula Le Guin's 'The Ones Who Walk Away from Omelas'. Has never left Korean music charts since 2017 — a world record.",
          ...
          {
            id: 'eight-iu', title: 'eight (feat. SUGA)', artist: 'IU',
          ...
          {
            id: 'hype-boy', title: 'Hype Boy', artist: 'NewJeans',
          ...
          {
            id: 'celebrity-iu', title: 'Celebrity', artist: 'IU',
          ...
          {
            id: 'love-scenario', title: 'Love Scenario', artist: 'iKON',
    ...
    anger: [
      {
        ...
        songs: [
          {
            id: 'bohemian', title: 'Bohemian Rhapsody', artist: 'Queen',
          ...
          {
            id: 'smells-like-teen', title: 'Smells Like Teen Spirit', artist: 'Nirvana',
            cover: 'https://i.scdn.co/image/ab67616d0000b273e3e4b9e8e4a7cc56a03e7f6d',
            spotify: 'https://open.spotify.com/track/5ghIJDpPoe3CjHMGu71E6T',
            storyEn: "Kurt Cobain wrote this trying to sound like The Pixies. What he created was the anthem of an entire generation's disillusionment. The title came from a friend who wrote 'Kurt smells like Teen Spirit' on his wall. It defined alternative rock forever.",
          ...
          {
            id: 'master-puppets', title: 'Master of Puppets', artist: 'Metallica',
            ...
            storyEn: "An indictment of drug addiction — the 'master' is the drug controlling you. The mid-song acoustic passage is one of the most beautiful, unexpected moments in metal history. Stranger Things introduced it to a new generation.",
            storyAr: "إدانة لإدمان المخدرات — 'السيد' هو المخدر الذي يتحكم بك. المقطع الأكوستيكي في منتصف الأغنية من أجمل اللحظات في تاريخ الميتال."
          },
          {
            id: 'highway-hell', title: 'Highway to Hell', artist: 'AC/DC',
            ...
            storyEn: "Bon Scott wrote this about the exhausting life on the road. Tragically his last studio album before his death. The riff became one of the most recognizable in all of rock history. It plays every day somewhere on Earth.",
      ...
      {
        id: 'nu-metal', name: '⚡ Nu-Metal Energy',
        songs: [
          {
            id: 'in-the-end', title: 'In the End', artist: 'Linkin Park',
            ...
            storyEn: "Written about effort that goes unrecognized — putting everything into something only for it to mean nothing. Almost cut from the album. Became one of the best-selling rock songs of the 2000s. Chester Bennington's pain is deeply real.",
          ...
          {
            id: 'numb', title: 'Numb', artist: 'Linkin Park',
          ...
          {
            id: 'break-stuff', title: 'Break Stuff', artist: 'Limp Bizkit',
            ...
            storyEn: "Fred Durst wrote this about a genuinely terrible day — everything going wrong, pure unfiltered rage. The anthem for anyone who ever wanted to just explode. Its raw aggression became cathartic for millions.",
            storyAr: "كتبها فريد دورست عن يوم سيئ حقيقي — كل شيء يسوء، غضب صافٍ بلا فلتر. أصبحت نشيداً لكل من أراد الانفجار."
          },
          {
            id: 'killing-name', title: 'Killing in the Name', artist: 'Rage Against the Machine',
            ...
            storyEn: "A direct challenge to systemic racism and police brutality. Zack de la Rocha's delivery is one of the most politically charged in rock history. Beat the X Factor winner to UK #1 in 2009.",
    ...
    sadness: [
      {
        id: 'greatest-sad', name: '💙 Greatest Sad Songs',
        songs: [
          {
            ...
            storyEn: "Adele wrote this about a real breakup — showing up at an ex's door to find he had moved on. She performed it live at the BRITs and made an entire arena cry. Music psychologist Dr. Jacob Jolij called it scientifically the saddest song ever.",
            storyAr: "كتبتها أديل عن فراق حقيقي — الوصول لباب حبيب سابق لتجده قد تجاوز الأمر. عندما أدّتها في حفل BRITs، بكى المكان بأكمله."
          },
          {
            id: 'skinny-love', title: 'Skinny Love', artist: 'Bon Iver',
            ...
            storyEn: "Justin Vernon wrote this isolated in a Wisconsin cabin after a breakup and serious illness. 'Skinny Love' is about a relationship barely surviving — kept alive by two people with no energy left to truly love each other. Pitchfork gave the album a perfect score.",
            storyAr: "كتب جاستن فيرنون الألبوم في كابينة معزولة في ويسكونسن. 'Skinny Love' عن علاقة تكاد تموت — يُبقيها حيّة شخصان لم يعد لديهما طاقة للحب الحقيقي."
          },
          {
            id: 'the-scientist', title: 'The Scientist', artist: 'Coldplay',
            ...
            storyEn: "Chris Martin wrote this at piano after a breakup, playing it emotionally in reverse — starting at the end, going back to the beginning. The music video literally plays backward. About wanting to undo the damage before everything broke.",
          ...
          {
            id: 'hurt', title: 'Hurt', artist: 'Johnny Cash',
            ...
            storyEn: "Trent Reznor wrote the original, but when Johnny Cash recorded it at 71 — months before his death, just after his wife June died — it became something else entirely. Reznor said: 'It's his song now'. Voted most emotionally powerful music video ever made.",
          ...
          {
            id: 'drivers-license', title: "drivers license", artist: 'Olivia Rodrigo',
            ...
            storyEn: "Olivia wrote this in her bedroom about getting your driver's license with no one to share it with. Broke the Spotify first-week record with 76 million streams. Music journalists called it 'the defining sad song of a generation'.",
            storyAr: "كتبتها أوليفيا في غرفتها عن الحصول على رخصة القيادة دون أحد لمشاركتها. كسرت رقم Spotify للأسبوع الأول بـ 76 مليون استماع."
          }
        ]
      },
      {
        id: 'indie-sad', name: '🌧️ Indie Tears',
        songs: [
          {
            id: 'moon-song', title: 'Moon Song', artist: 'Phoebe Bridgers',
          ...
          {
            id: 'cardigan', title: 'cardigan', artist: 'Taylor Swift',
            ...
            storyEn: "Part of Taylor's 'folklore' trilogy about a love triangle from three perspectives. 'cardigan' tells it from the girl's view — being someone's second choice, knowing they'll come back when no one else will have them.",
            storyAr: "جزء من ثلاثية 'folklore' عن مثلث حب. تحكيها 'cardigan' من منظور الفتاة — الألم من كونكِ الخيار الثاني."
          },
          {
            id: 'traitor', title: 'traitor', artist: 'Olivia Rodrigo',
            cover: 'https://i.scdn.co/image/ab67616d0000b273a91c10fe9472d9bd89802e52',
    ...
    euphoria: [
      {
        id: 'peak-energy', name: '⚡ Peak Energy',
        songs: [
          {
            ...
            storyEn: "Inspired by 1980s synthwave — specifically driving at night. Became the best-charting song in Billboard Hot 100 history. Its euphoric energy is scientifically linked to dopamine release by music researchers at McGill.",
          ...
          {
            id: 'uptown-funk', title: 'Uptown Funk', artist: 'Mark Ronson ft. Bruno Mars',
            ...
            storyEn: "Took Mark Ronson and Bruno Mars over a year — they kept feeling something was missing. The result spent 14 weeks at #1 in the US. Rolling Stone called it 'a masterclass in funk production'. Physically impossible to be sad while it plays.",
          ...
          },
          {
            ...
            storyEn: "ABBA recorded this the night before the King of Sweden's wedding. A perfect pop song — pure distilled joy. Musicologists found its chord progression physically mimics the feeling of a dance. Still makes every room happy 45 years later.",
          ...
          {
            id: 'dont-stop-me-now', title: "Don't Stop Me Now", artist: 'Queen',
            cover: 'https://i.scdn.co/image/ab67616d0000b273e8d8fc34c0b6e75a1ecdf99a',
            spotify: 'https://open.spotify.com/track/5T8EDUDqKcs6OSOwEsfqG7',
            storyEn: "Freddie Mercury wrote this at the height of his personal excess — wild parties, pure euphoria of being alive. Scientists at University of Manchester calculated it as the world's most perfect feel-good song based on tempo, pitch, and chord progression.",
          ...
          {
            id: 'happy-pharrell', title: 'Happy', artist: 'Pharrell Williams',
            ...
            storyEn: "Pharrell wrote 10 versions before this one. Originally for Despicable Me 2. Went to #1 in 24 countries. Music researchers at University of Groningen found it physiologically induces happiness by mirroring the brain's reward pattern.",
      ...
      {
        id: 'kpop-hype', name: '🔥 K-Pop Hype',
        songs: [
          {
            id: 'dynamite', title: 'Dynamite', artist: 'BTS',
            cover: 'https://i.scdn.co/image/ab67616d0000b273b4e63903a63fc7b0cbbf04f8',
            spotify: 'https://open.spotify.com/track/0t1kP63rueHleOhQkYSXFY',
            storyEn: "BTS's first all-English song, released during COVID-19 to bring joy worldwide. Debuted at #1 on Billboard Hot 100 — first Korean act ever. The members cried after recording it because it felt like a gift to the world.",
            storyAr: "أول أغنية بالكامل بالإنجليزية لـ BTS، أُطلقت خلال كوفيد-19 لإدخال البهجة. صعدت لـ#1 في Billboard Hot 100 — أول فنان كوري يحقق ذلك."
          },
          {
            id: 'fearless', title: 'FEARLESS', artist: 'LE SSERAFIM',
            ...
            storyAr: "أغنية ديبيو لـ LE SSERAFIM هي إعلان — اسم المجموعة يعني 'أنا لا أخشى شيئاً'. عن المضي قدماً بغض النظر عما يقوله الناس."
          },
          {
            id: 'super-shy', title: 'Super Shy', artist: 'NewJeans',
            cover: 'https://i.scdn.co/image/ab67616d0000b27352af9df1d2a40d0c0d00f7e8',
            spotify: 'https://open.spotify.com/track/3mfGQmMfaHf0mJtI6h6UMB',
            storyEn: "Captures the specific euphoria of having a crush and not being able to say it. The 2000s-influenced production and youthful energy made it a global hit beyond K-Pop audiences. It is the sonic equivalent of butterflies.",
    ...
    melancholy: [
      {
        id: 'beautiful-dark', name: '🌙 Beautiful & Dark',
        songs: [
          {
            id: 'retrograde', title: 'Retrograde', artist: 'James Blake',
            ...
            storyAr: "واحدة من تلك الأغاني النادرة التي تصنع جوّها الخاص. البيانو الافتتاحي والإنتاج الإلكتروني المتصاعد يصنعان شيئاً يبدو كالنظر لمدينة من بعيد ليلاً."
          },
          {
            id: 'holocene', title: 'Holocene', artist: 'Bon Iver',
          ...
          {
            id: 'wait-m83', title: 'Wait', artist: 'M83',
          ...
          {
            id: 'liability', title: 'Liability', artist: 'Lorde',
            ...
            storyAr: "كتبتها إيلا عن كونكِ 'أكثر من اللازم' للناس — الشخصية التي تضيء بقوة فتحرق الآخرين."
          },
          {
            id: 'reaper-sia', title: 'Reaper', artist: 'Sia',
            ...
            storyAr: "كتبتها سيا عن الاكتئاب — الشعور بأن الموت يتبعك. لكنها حوّلته لشيء مُمكِّن. الإنتاج يتصاعد لشيء شبه منتصر."
          }
        ]
      }
    ],
    ...
    nostalgia: [
      {
        id: 'throwback', name: '📼 Throwback Hits',
        songs: [
          {
            id: 'september', title: 'September', artist: 'Earth, Wind & Fire',
            ...
            storyEn: "'Do you remember the 21st night of September?' — one of the most iconic lines in pop. Allee Willis was asked why the 21st. She said: 'It just sounded right'. No deeper meaning. Pure joy that has made people happy for 45 years.",
          ...
          },
          {
            ...
            storyEn: "Stevie Nicks wrote this in 10 minutes. Fleetwood Mac's only US #1. In 2020, Nathan Apodaca's TikTok skateboard video sent it back to the top 43 years after release — one of the greatest viral moments in music history.",
          ...
          {
            id: 'take-on-me', title: 'Take On Me', artist: 'a-ha',
            ...
            storyEn: "a-ha recorded three different versions before the iconic final take. The revolutionary pencil-sketch music video took 16 weeks to produce. Reached #1 in 36 countries. The falsetto note is one of the most recognizable in pop history.",
          ...
          {
            id: 'dont-stop-believin', title: "Don't Stop Believin'", artist: 'Journey',
            cover: 'https://i.scdn.co/image/ab67616d0000b2734e0a0b52dc88e67498d2a64c',
            spotify: 'https://open.spotify.com/track/4bHsxqR3GMrXTxEPLuK5ue',
            storyEn: "Steve Perry wrote this about small-town kids chasing their dreams. It became the best-selling digital catalog single of the 20th century. The Sopranos finale used it — making it instantly iconic all over again.",
            storyAr: "كتبها ستيف بيري عن أطفال المدن الصغيرة يلاحقون أحلامهم. أصبحت أكثر أغاني الكتالوج الرقمي مبيعاً في القرن العشرين."
          },
          {
            id: 'eye-tiger', title: 'Eye of the Tiger', artist: 'Survivor',
      ...
      {
        id: 'kpop-nostalgia', name: '🌸 K-Pop Nostalgia',
        songs: [
          {
            id: 'attention-nj', title: 'Attention', artist: 'NewJeans',
            cover: 'https://i.scdn.co/image/ab67616d0000b27352af9df1d2a40d0c0d00f7e8',
            spotify: 'https://open.spotify.com/track/0n67oJBVVinGMJoaKgGRFV',
            storyEn: "NewJeans' debut arrived fully formed — confident, Y2K-influenced. Shot on film cameras, it gave a nostalgic quality making listeners feel they were remembering something they'd never experienced. It redefined 4th gen K-Pop sound.",
            storyAr: "أغنية ديبيو لـ NewJeans وصلت مكتملة — واثقة، بتأثيرات Y2K. صُوِّر على كاميرات فيلمية، مما أعطاه طابعاً حنينياً."
          },
          {
            id: 'ditto-nj', title: 'Ditto', artist: 'NewJeans',
            cover: 'https://i.scdn.co/image/ab67616d0000b27352af9df1d2a40d0c0d00f7e8',
            spotify: 'https://open.spotify.com/track/17fDm2FaVSgL7XHs0SBBXZ',
            storyEn: "A K-Pop anomaly — slow, nostalgic, shot on camcorder aesthetic, yet became one of the most-streamed K-Pop songs ever. The feeling of wanting to freeze a perfect moment. Critics say it defined a new era of sound.",
            storyAr: "'Ditto' شاذة في K-Pop — بطيئة، حنينية، بجمالية كاميرا قديمة. الشعور برغبة تجميد لحظة مثالية مع شخص ما."
          },
          {
            id: 'omg-nj', title: 'OMG', artist: 'NewJeans',
            cover: 'https://i.scdn.co/image/ab67616d0000b27352af9df1d2a40d0c0d00f7e8',
            spotify: 'https://open.spotify.com/track/6yb9tmdabIMRGBUZ8klNsJ',
            storyEn: "Two songs in one — first a dreamy delicate piece, then an explosive party drop. The duality mirrors the experience of having an overwhelming crush. The music video went viral for its abstract, unsettling storyline.",
